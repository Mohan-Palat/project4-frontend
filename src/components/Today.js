		...
		return (
			<>
				<div className="song">
					...
					<p>{allCountSongs.length} unique songs were played {songLength} times today.  That's about {songAverage} per hour!</p>
					<p>Below are the unique songs and the number of times they played today.</p>
					<table>
